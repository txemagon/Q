...
class LevelsControllerTest < ActionController::TestCase
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post :create, level: { children_count: @level.children_count, depth: @level.depth, lft: @level.lft, name: @level.name, parent_id: @level.parent_id, rgt: @level.rgt }
    end
  ...
  test "should update level" do
    patch :update, id: @level, level: { children_count: @level.children_count, depth: @level.depth, lft: @level.lft, name: @level.name, parent_id: @level.parent_id, rgt: @level.rgt }
    assert_redirected_to level_path(assigns(:level))
  end
